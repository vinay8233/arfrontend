...
const Nokhavillagecommunitycentre  = () => {
    ...
    return (
        <>
            ...
            <h5 className="township-heading text-center">Nokha Village Community Centre,</h5>
...
export default Nokhavillagecommunitycentre ;
